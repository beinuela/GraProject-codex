<template>
  <div class="page-card">
    ...
    <el-dialog append-to-body v-model="visible" title="物资分类" width="480">
...
const openCreate = () => { Object.assign(form, { id: null, categoryName: '', categoryCode: '', remark: '' }); visible.value = true }
