<template>
  <div class="page-card">
    ...
    <el-table :data="list" border>
      ...
      <el-table-column prop="campusId" label="所属校区ID" width="110" />
    ...
    <el-dialog v-model="visible" title="仓库信息" width="520">
      <el-form :model="form" label-width="90px">
        ...
        <el-form-item label="所属校区ID"><el-input-number v-model="form.campusId" :min="1" style="width:100%" /></el-form-item>
...
const openCreate = () => { Object.assign(form, { id: null, warehouseCode: '', warehouseName: '', campusId: null, address: '', manager: '', contactPhone: '', remark: '' }); visible.value = true }
