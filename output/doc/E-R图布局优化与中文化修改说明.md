...
- 工作底稿：`校园物资智能管理系统设计与实现-E-R图减交叉精修版.docx`
- 备份文件：`校园物资智能管理系统设计与实现-E-R图减交叉精修版-中文规范优化前备份-20260429174336.docx`
- 输出文件：`校园物资智能管理系统设计与实现-E-R图中文规范优化版.docx`
...
- `图5-1 用户角色与组织 E-R 图`：已完成 完成中文化，并以用户为中心重新整理四向关系支路。
- `图5-2 库存与批次 E-R 图`：已完成 完成中文化，并按物资分类-物资档案-库存-库存批次主干重排。
- `图5-3 业务单据、预警与通知 E-R 图`：已完成 完成中文化，并按申领/出库与调拨/预警/通知双模块重排。
...
- `word/media/image7.png` -> `fig_3_3_rbac_er.png`，MD5=`19668a7f1facbe75d7af042f2c190a83`。
- `word/media/image8.png` -> `fig_3_4_inventory_er.png`，MD5=`a0978c62b58881e6478a505b930f865c`。
- `word/media/image9.png` -> `fig_3_5_business_er.png`，MD5=`ec1372653bba6bf34ba585959bff61cf`。
